  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <div className="panel p-5"><div className="label">Bot</div><div className="text-2xl font-bold">{status?.botActive ? 'Running' : 'Paused'}</div><div className="mt-3 text-sm text-zinc-400">Worker: {status?.workerBotActive ? 'active' : 'idle'}</div></div>
        ...
        <div className="panel p-5"><div className="label">Next cycle</div><div className="text-2xl font-bold">{Math.ceil(nextDrawMs / 1000)}s</div><div className="mt-3 text-sm text-zinc-400">Worker uptime {formatDuration(status?.uptime || 0)}</div></div>
      </div>
