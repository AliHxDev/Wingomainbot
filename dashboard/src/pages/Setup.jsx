        ...
        {step === 3 && (
          <div className="space-y-6">
            <div className="rounded-2xl border border-zinc-800 bg-zinc-950 p-6">
              ...
              <p className="mt-2 text-sm leading-6 text-zinc-400">The bot service will fetch WinGo history every minute, analyze the latest 30 draws, send signals above the confidence threshold, and settle each signal after the next result arrives.</p>
            </div>
